...
const moveSFX = new Audio("sfx/sfx_move.mp3");
const scoreSFX = new Audio("sfx/sfx_score.mp3");
const startgameSFX = new Audio("sfx/sfx_startgame.mp3");

moveSFX.volume = 0.5;
scoreSFX.volume = 0.5;

const background_img = new Image();
background_img.src = "sprites/myroad.png"
const my_car_img = new Image();
my_car_img.src = "sprites/my_car.png"
const enemy_cars_img = [new Image(), new Image()];
enemy_cars_img[0].src = "sprites/enemy_car1.png";
enemy_cars_img[1].src = "sprites/enemy_car2.png";
